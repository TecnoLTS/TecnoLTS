...
const serviceThemes: Record<string, ServiceTheme> = {
  ...
  Radar: {
    ...
    panel: {
      titleEs: 'Operación bajo control',
      titleEn: 'Operations under control',
      subtitleEs: 'Detección temprana para evitar caídas críticas',
      subtitleEn: 'Early detection to prevent critical outages',
    },
    lead: {
      es: 'Convertimos monitoreo en continuidad operativa: menos incidentes críticos, menor tiempo de respuesta y clientes mejor atendidos.',
      en: 'We turn monitoring into business continuity: fewer critical incidents, faster response times, and better customer experience.',
    },
    impactTitle: {
      es: 'Continuidad operativa impulsada por observabilidad',
      en: 'Operational continuity powered by observability',
    },
    finalSubtitle: {
      es: 'Le proponemos una arquitectura de observabilidad con métricas, alertas y tableros listos para responder con velocidad.',
      en: 'We deliver an observability architecture with metrics, alerts, and dashboards ready for fast response.',
    },
    stackLabel: {
    ...
    metrics: {
      ...
      b: {
        es: 'Cobertura de alertas',
        en: 'Alert coverage',
        valueEs: 'Priorizada por impacto',
        valueEn: 'Impact-prioritized',
        width: 'w-[89%]',
        barClass: 'from-emerald-400 to-cyan-500',
      },
    },
    kpis: [
      { valueEs: '24/7 visible', valueEn: '24/7 visibility', es: 'Estado operativo en tiempo real', en: 'Real-time operational status' },
      { valueEs: 'Menos caídas', valueEn: 'Fewer outages', es: 'Alertas antes del impacto', en: 'Alerts before impact' },
      { valueEs: 'Respuesta rápida', valueEn: 'Faster response', es: 'Diagnóstico con contexto', en: 'Context-rich diagnostics' },
    ],
    focusIcons: [Radar, Activity, Network],
    palette: {
      heroGlowClass:
        'bg-[radial-gradient(circle_at_14%_0%,rgba(6,182,212,0.2),transparent_34%),radial-gradient(circle_at_86%_10%,rgba(16,185,129,0.14),transparent_36%)]',
      ...
      ctaClass: 'bg-gradient-to-r from-cyan-500 via-blue-500 to-emerald-500',
...
const serviceIncludes: Record<string, { es: string[]; en: string[] }> = {
  ...
  Radar: {
    es: ['Alertas inteligentes', 'Visibilidad en tiempo real', 'Respuesta más rápida'],
    en: ['Smart alerts', 'Real-time visibility', 'Faster response'],
  },
  Shield: {
...
const serviceImageIdeas: Record<string, ServiceImageIdeas> = {
  ...
  Radar: {
    main: {
      es: 'Equipo revisando el estado completo de la operación en tiempo real.',
      en: 'Team reviewing full operational health in real time.',
    },
    sideA: {
      es: 'Panel de alertas claras para actuar antes de una caída.',
      en: 'Clear alert dashboard to act before outages.',
    },
    sideB: {
      es: 'Ingeniero validando mejoras de rendimiento y estabilidad.',
      en: 'Engineer validating performance and stability improvements.',
    },
  },
  Shield: {
    main: {
...
const serviceImageRefs: Record<string, ServiceImageRefs> = {
  Code: {
    main: '/images/services/software/Desarrollo-de-software-TecnoLTS.jpg',
  },
  Radar: {
    main: '/images/services/monitoring/Monitoreo-y-observabilidad-TecnoLTS.jpg',
  },
  Shield: {
    main: '/images/services/cybersecurity/Ciberseguridad-TecnoLTS.jpg',
  },
  Network: {
    main: '/images/services/network/Soluciones-de-redes-TecnoLTS.jpg',
  },
  Lock: {
    main: '/images/services/iso-27001/Cumplimiento-que-abre-nuevas-oportunidades-TecnoLTS.jpg',
  },
  Layers: {
    main: '/images/services/backups/Gestion-de-respaldos-TecnoLTS.jpg',
  },
  Server: {
    main: '/images/services/licensing/Licenciamiento-de-software-TecnoLTS.jpg',
  },
  Zap: {
    main: '/images/services/disaster-recovery/Recuperacion-ante-desastres-TecnoLTS.jpg',
  },
  HardDrive: {
    main: '/images/services/datacenter/Diseno-de-data-center-TecnoLTS.jpg',
  },
};
...
export default function ServiceDetailPage({
  ...
  const imageRefs = serviceImageRefs[iconName] || serviceImageRefs.Code;
        ...
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-8 lg:grid-cols-12 lg:items-start lg:gap-10">
            <div className="lg:col-span-4">
              <div
                data-image-slot="service-capabilities-image"
                className="relative overflow-hidden rounded-[1.8rem] border border-slate-200 bg-slate-100 min-h-[300px] sm:min-h-[360px] lg:min-h-[520px] dark:border-slate-700 dark:bg-slate-900"
              >
                <Image
                  src={imageRefs.main}
                  alt={isEs ? imageIdeas.main.es : imageIdeas.main.en}
                  fill
